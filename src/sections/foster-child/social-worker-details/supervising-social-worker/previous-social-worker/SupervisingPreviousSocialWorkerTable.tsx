...
import { useSupervisingPreviousSocialWorkerTable } from "./useSupervisingPreviousSocialWorkerTable";

export default function SupervisingPreviousSocialWorkerTable(props: any) {
  ...
  const {
    ...
    meta,
    pageChangeHandler,
  } = useSupervisingPreviousSocialWorkerTable();
  const columns = [
    {
