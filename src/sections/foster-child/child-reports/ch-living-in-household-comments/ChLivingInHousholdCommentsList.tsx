...
import { useChLivingInHousholdCommentsList } from "./useChLivingInHousholdCommentsList";
...
const ChLivingInHousholdCommentsList = () => {
  const {
    tableHeaderRef,
    columns,
    data,
    ...
    setPage,
    therapInfoCon,
  }: any = useChLivingInHousholdCommentsList();
...
export default ChLivingInHousholdCommentsList;
