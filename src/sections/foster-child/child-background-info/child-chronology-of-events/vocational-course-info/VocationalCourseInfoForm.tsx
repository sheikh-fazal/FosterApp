...
import { VocationalCourseInfoFormFields } from "./VocationalCourseInfoData";
import FormProvider from "@root/components/hook-form/FormProvider";
import { RHFSelect, RHFTextField } from "@root/components/hook-form";
import { LoadingButton } from "@mui/lab";
import { useVocationalCourseInfoForm } from "./useVocationalCourseInfoForm";
import SkeletonFormdata from "@root/components/skeleton/SkeletonFormdata";

const VocationalCourseInfoForm = () => {
  const { router, methods, onSubmit, handleSubmit, isSubmitting, isLoading, action,fosterChildId } =
    useVocationalCourseInfoForm();
    ...
    <Grid>
      <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
        ...
        <Grid container rowSpacing={4} columnSpacing={5} alignItems="center">
          {VocationalCourseInfoFormFields.map((form: any) => {
            return (
...
export default VocationalCourseInfoForm;
