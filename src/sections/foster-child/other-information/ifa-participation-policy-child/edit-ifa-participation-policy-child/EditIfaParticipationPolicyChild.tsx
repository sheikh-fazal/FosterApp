...
const EditIfaParticipationPolicyChild = (props: any) => {
  const {
    disabled,
    onSubmitHandler,
    handleCloseForm,
  ...
  const { methods, handleSubmit, onSubmit, setValue, data,isLoading } =
...
export default EditIfaParticipationPolicyChild;
