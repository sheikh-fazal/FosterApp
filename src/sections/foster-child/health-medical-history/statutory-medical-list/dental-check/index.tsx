...
export const dentalCheckListTableColumnsFunction = (router?: any) => [
    {
          ...
          return (
            <Box sx={{ display: "flex", gap: "5px", justifyContent: "center" }}>
              ...
              <TableAction
                ...
                onClicked={() =>
                  router.push(
                    `/foster-child/health-medical-history/statutory-medical-list/dental-check-info/${info?.row?.id}?action=edit`
                  )
                }
              />
              <TableAction
