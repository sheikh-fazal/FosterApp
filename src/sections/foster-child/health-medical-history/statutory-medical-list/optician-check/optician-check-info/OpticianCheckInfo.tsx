...
import { useOpticianCheckInfo } from "./useOpticianCheckInfo";



const OpticianCheckInfo = () => {
  const { opticianCheckInfoFormData, methods, handleSubmit, submitGpDetailsInfoForm, getSingleGpDetailsInfoDataStatus, query, router } =
  useOpticianCheckInfo();
  ...
  return (
    <FormProvider methods={methods} onSubmit={handleSubmit(submitGpDetailsInfoForm)}>
      <Grid container spacing={5}>
        {opticianCheckInfoFormData.map((form: any, index: number) => {
          return (
...
export default OpticianCheckInfo;
