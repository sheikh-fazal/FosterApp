      ...
      return (
        <Box sx={{ display: "flex", gap: "5px", justifyContent: "center" }}>
          ...
          <TableAction
            ...
            onClicked={() =>
              router.push(
                `/foster-child/health-medical-history/statutory-medical-list/ehcp-info/${info?.row?.id}?action=edit`
              )
            }
          />
          <TableAction
            ...
            onClicked={() =>
              router.push(
                `/foster-child/health-medical-history/statutory-medical-list/ehcp-info/${info?.row?.id}?action=view`
              )
            }
          />
        </Box>
