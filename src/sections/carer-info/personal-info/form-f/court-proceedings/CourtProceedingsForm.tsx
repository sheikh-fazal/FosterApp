...
import { COURTPROCEEDINGSFORMDATA, FormSchema, defaultValues } from ".";
import { LoadingButton } from "@mui/lab";

export default function CourtProceedingsForm(props: any) {
      ...
      <Card sx={{ p: 2 }}>
        <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
          <Grid container spacing={3}>
            ...
            {COURTPROCEEDINGSFORMDATA?.map((form: any) => {
              return (
