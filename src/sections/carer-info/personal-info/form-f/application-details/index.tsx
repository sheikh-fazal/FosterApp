...
export const defaultValues = {
  faimlyName: "family name here",
  previousName: "prev name",
  foreNames: "recommended",
  otherName: "otherName",
  dateOfBirth: new Date(ageOf18Years),
  age: "age",
  placeOfBirth: "+4412312345",
  ...
  primaryLanguage: "nationality",
  otherLanguage: "nationality",
  religion: "nationality",
  practisingOrNonPractising: "practicing",
  applicantasDisabled: "nationality",
  partnershipStatusQuestion: "nationality",
  partershipStatusQuestion2: "nationality",

  childrenHoueHoldFaimlyName: "nationality",
  childrenHouseHoldForeNames: "nationality",
  childrenHouseHoldSex: "nationality",
  childrenHouseHoldRelationship: "nationality",
  childrenHouseHoldDateOfBirth: new Date(ageOf18Years),
  childrenHouseHoldAge: "nationality",

  adultHouseHoldFaimlyName: "nationality",
  adultHouseHoldForeNames: "nationality",
  adultHouseHoldSex: "nationality",
  adultHouseHoldRelationship: "nationality",
  adultHouseHoldDateFfBirth: new Date(ageOf18Years),
  adultHouseHoldAge: "nationality",

  childrenHoueHoldFaimlyNameElseWhere: "nationality",
  childrenHouseHoldForeNamesElseWhere: "nationality",
  childrenHouseHoldSexElseWhere: "nationality",
  childrenHouseHoldRelationshipElseWhere: "nationality",
  childrenHouseHoldDateFfBirthElseWhere: new Date(ageOf18Years),
  childrenHouseHoldAgeElseWhere: "nationality",

  adultHouseHoldFaimlyNameElseWhere: "nationality",
  adultHouseHoldForeNamesElseWhere: "nationality",
  adultHouseHoldSexElseWhere: "nationality",
  adultHouseHoldRelationshipElseWhere: "nationality",
  adultHouseHoldDateOfBirthElseWhere: new Date(ageOf18Years),
  adultHouseHoldAgeElseWhere: "nationality",

  previousPartnersQuestion1: "nationality",
  previousPartnersQuestion2: "nationality",
};
