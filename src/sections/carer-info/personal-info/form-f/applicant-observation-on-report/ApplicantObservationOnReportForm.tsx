...
import { APPLICANTOBSERVATIONREPORTDATA, FormSchema, defaultValues } from ".";
import { LoadingButton } from "@mui/lab";

export default function ApplicantObservationOnReportForm(props: any) {
          ...
          <Grid container spacing={3}>
            <Grid item md={12}>
              <Typography variant="h6">
                The Applicant(s) Observation On the Report
              </Typography>
            </Grid>
            ...
            {APPLICANTOBSERVATIONREPORTDATA?.map((form: any) => {
              return (
