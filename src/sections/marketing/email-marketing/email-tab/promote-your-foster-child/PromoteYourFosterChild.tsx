...
import { usePromoteYourFosterChild } from './usePromoteYourFosterChild';
// form react hook
import { FormProvider } from "@root/components/hook-form";


const PromoteYourFosterChild = () => {
  const { methods, handleSubmit,  onSubmit, onClear } = usePromoteYourFosterChild();
  return (
...
export default PromoteYourFosterChild