...
import { useMeetOurNewHeadOfSafeguarding } from './useMeetOurNewHeadOfSafeguarding';
// form react hook
import { FormProvider } from "@root/components/hook-form";


const MeetOurNewHeadOfSafeguarding = () => {
  const { methods, handleSubmit,  onSubmit, onClear } = useMeetOurNewHeadOfSafeguarding();
  return (
...
export default MeetOurNewHeadOfSafeguarding