...
const DigitalSafeguardingInFostering = () => {
  const { methods, handleSubmit,  onSubmit, onClear } = useDigitalSafeguardingInFostering();
  return (
...
export default DigitalSafeguardingInFostering
