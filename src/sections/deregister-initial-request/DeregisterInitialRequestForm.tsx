...
import { useDeregisterInitialRequestForm } from './useDeregisterInitialRequestForm';
import { FormProvider } from '@root/components/hook-form';

const DeregisterInitialRequestForm = () => {
  const { methods, onSubmit, handleSubmit, } = useDeregisterInitialRequestForm();
  return (
...
export default DeregisterInitialRequestForm
