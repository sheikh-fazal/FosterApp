        ...
        <>
                    ...
                    <Grid item xl={4} lg={4} md={6} xs={12} key={index}>
                        <Link href={card.link} style={{ all: "unset" }}>
                            <Box sx={styles.policyCardsWrapper(card.bgColor)}>
                                ...
                                <Box sx={{ flexBasis: "content" }}><Image src={card.icon} alt={card.title} /></Box>
                            </Box>
                        </Link>
                    </Grid>))}
            </Grid>
            <Grid container pt="24px" columnSpacing="24px">
                <Grid item xl={5} lg={12} md={12} xs={12}>
                    <Card sx={{ padding: "20px", marginBottom: "24px", ...styles.tableWrapper }}>
                        <TableHeader
                    ...
                    <Card sx={{ padding: "13px" }}>
                        <Typography variant='h5' sx={{ fontSize: "16px", mb: 0 }}>Reminders & Notifications</Typography>
                ...
                <Grid item xl={7} lg={12} md={12} xs={12}>
                    <Card sx={{ padding: "18px", mt: { xl:0,md: 2, sm: 2, xs: 2 } }}>
                        <Typography fontSize={20} color="#DC3545" fontWeight={600} mb={3}>Local Authority Statistics</Typography>
                        <Chart />
                    </Card>
                </Grid>
            </Grid>
...
const styles = {
    ...
    policyCardsWrapper: (color: string) => ({
        background: color, borderRadius: "10px", boxShadow: "0px 0px 7px 3px rgba(14, 145, 140, 0.2)", display: "flex", justifyContent: "space-between", padding: "20px", minHeight: "120px", height: "100%", cursor: "pointer"
    }),
    cardsText: {
        color: "white", fontSize: "24px", fontWeight: "600", paddingTop: "50px"
    }
}
