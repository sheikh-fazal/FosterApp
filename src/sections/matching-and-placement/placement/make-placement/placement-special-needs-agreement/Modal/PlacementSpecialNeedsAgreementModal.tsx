...
import { usePlacementSpecialNeedsAgreementModal } from "./usePlacementSpecialNeedsAgreementModal";
...
const PlacementSpecialNeedsAgreementModal = (props: IProps) => {
  const { open, handleClose, onSubmit,title,} = props;
  const { methods, handleSubmit } = usePlacementSpecialNeedsAgreementModal();
...
export default PlacementSpecialNeedsAgreementModal;
