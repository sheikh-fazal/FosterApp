...
import { useFinalPlacementApprovalAddModal } from "./useFinalPlacementApprovalAddModal";
...
const FinalPlacementApprovalAddModal = (props: IProps) => {
  const { open, handleClose, onSubmit,title,} = props;
  const { methods, handleSubmit } = useFinalPlacementApprovalAddModal();
...
export default FinalPlacementApprovalAddModal;
