...
import { useSelfCareSkills } from './useSelfCareSkills';

const SelfCareSkills = () => {

  const { methods, handleSubmit, onSubmit, disabled, handleBack } = useSelfCareSkills();

  return (
    <Card sx={styles.card}>
      <Typography sx={styles.title}>Self care skills/Preparing for independence</Typography>
