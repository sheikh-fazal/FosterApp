...
import { usePlacementDetails } from './usePlacementDetails';

const PlacementDetails = () => {

  const { methods, handleSubmit, onSubmit, disabled, handleBack } = usePlacementDetails();

  return (
    <Card sx={styles.card}>
      <Typography sx={styles.title}>Placement Details</Typography>
