...
import { useLivingTogether } from './useLivingTogether';

const LivingTogether = () => {

  const { methods, handleSubmit, onSubmit, disabled, handleBack } = useLivingTogether();

  return (
    <Card sx={styles.card}>
      <Typography sx={styles.title}>Living Together</Typography>
