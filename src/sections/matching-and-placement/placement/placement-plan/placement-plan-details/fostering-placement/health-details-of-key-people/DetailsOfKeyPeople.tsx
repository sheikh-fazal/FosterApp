...
import { useHealthDetailsOfKeyPeople } from './useHealthDetailsOfKeyPeople';
import { formData } from '.';

const HealthDetailsOfKeyPeople = () => {

  const { methods, handleSubmit, onSubmit, disabled, handleBack } = useHealthDetailsOfKeyPeople();

  return (
    <Card sx={styles.card}>
      <Typography sx={styles.title}>Health: Details of Key People</Typography>
