...
import { useEducationalNeeds } from './useEducationalNeeds';
import { formData } from '.';

const EducationalNeeds = () => {

  const { methods, handleSubmit, onSubmit, disabled, handleBack } = useEducationalNeeds();

  return (
    <Card sx={styles.card}>
      <Typography sx={styles.title}>Educational needs</Typography>
