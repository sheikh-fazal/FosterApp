...
const FosteredYoungPersonCommets = ({ action, id }: any) => {
  ...
  const { methods, onSubmit, handleSubmit, handleBack } = useFosteredYoungPersonCommets();
  return (
    <Card sx={{ p: 2 }}>
      <Box textAlign={'center'}>
        ...
        <Typography sx={{ fontWeight: 500, mb: '30px', fontSize: '16px', color: '#898989' }}>
          It is the responsibility of the supervising social worker to agree with the young person’s
          social worker how the young person will be approached to complete this form. Wherever
          possible, it should be completed by the young person in their own words, but if they need
          support this should be provided by the person they are most comfortable with (but not the
          foster carer). Each fostered young person should complete a separate form.
          Please note that this form will be shared with your foster carer(s). If you have relevant
          information that you think should not be shared with your foster carer(s) then please
          discuss this with your social worker.
        </Typography>
      </Box>
      <FormProvider
