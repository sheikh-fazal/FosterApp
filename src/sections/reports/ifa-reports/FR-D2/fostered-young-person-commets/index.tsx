...
export const FRD2FormData = [
  ...
  {
    gridLength: 6,
    title: "Name (fostered young person)",
    otherOptions: {
  ...
  {
    gridLength: 6,
    title: "Fostered young person's DOB-Age",
    otherOptions: {
      name: 'personDOB',
      fullWidth: true,
    },
  ...
  {
    gridLength: 12,
    title: 'Is there anything else you would like to say about living with your foster carers?',
    otherOptions: {
