...
import { useFRD2 } from './useFRD2';
import TableHeader from '@root/components/TableHeader';
import TableSubHeader from '../../table-sub-header/TableSubHeader';
import CustomTable from '@root/components/Table/CustomTable';
import TableAction from '@root/components/TableAction';
import DeleteModel from '@root/components/modal/DeleteModel';
import { FRD2FilterData, tableMockData, tableSubHeader } from '.';

const FRD2 = () => {
  const { handleSearch, handleAction, handleDeleteModal, deleteModal } = useFRD2();
      ...
      <Card sx={{ ...styles.cardStyle, py: 2, px: 1 }}>
        ...
        <Card sx={{ p: 2, my: 2 }}>
          <Grid container spacing={2}>
            {FRD2FilterData.map((data: any, i: number) => (
