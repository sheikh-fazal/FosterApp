...
export const formSchema = Yup.object().shape({
  ...
  expectationsAroundConfidentiality: Yup.string().required('Field is required.'),
  expectationsAroundConfidentialityComments: Yup.string().required('Field is required.'),
  doesFosterCarerWorkEffectively: Yup.string().required('Field is required.'),
  doesFosterCarerWorkEffectivelyCommets: Yup.string().required('Field is required.'),
  promoteContactWhereAppropriate: Yup.string().required('Field is required.'),
  promoteContactWhereAppropriateCommets: Yup.string().required('Field is required.'),
  healthyPhysicalAndEmotionalCare: Yup.string().required('Field is required.'),
  healthyPhysicalAndEmotionalCareComments: Yup.string().required('Field is required.'),
...
export const FREFormData = [
  ...
  {
    gridLength: 12,
    title: 'Does the foster carer listen to and take account of the individual needs, wishes, feelings and preferences of the child or young person?',
    otherOptions: {
  ...
  {
    gridLength: 12, head: 'Confidentiality'
  },
  {
    gridLength: 12,
    title: 'Does the foster carer comply with your expectations around confidentiality?',
    otherOptions: {
  ...
  {
    gridLength: 12,
    title: 'Does the foster carer work effectively with you as the child or young person’s social worker, and other professionals, including contributing to planning, and communicating effectively?',
    otherOptions: {
  ...
  {
    gridLength: 12,
    title: 'Does the foster carer understand the importance of the child or young person’s birth family, and work to support and promote contact where appropriate?',
    otherOptions: {
  ...
  {
    gridLength: 12,
    title: 'Does the foster carer promote the healthy physical and emotional care of the child or young person, including their sexual health (where appropriate)',
    otherOptions: {
  ...
  {
    gridLength: 12,
    title: 'Does the foster carer promote positive behaviour and manage any challenging behaviour safely and appropriately?',
    otherOptions: {
  ...
  {
    gridLength: 12,
    title: 'Does the foster carer communicate effectively with the child or young person according to their age and stage of development and encourage them to make their own decisions as appropriate?',
    otherOptions: {
  ...
  {
    gridLength: 12,
    title: 'Does the foster carer support the child or young person in relation to education, training and employment, including advocating that their educational needs are met?',
    otherOptions: {
      name: 'education',
      options: ['Yes', 'No']
    },
  ...
  {
    gridLength: 12,
    title: 'Does the foster carer keep the child or young person safe, and feeling safe, and help the child or young person keep themselves safe, including communicating with them about risk and safety?',
    otherOptions: {
  ...
  {
    gridLength: 12,
    title: 'If you have any additional comments, particularly any concerns that you might have, please provide details',
    otherOptions: {
