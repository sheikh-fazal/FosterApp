...
export const useChildIncidents = () => {
  const [openDelete, setOpenDelete] = useState(false);
  const router = useRouter();
  const path = "/reports/child-reports/child-incidents/child-incidents-form";
  const handleSearch = () => {};
  ...
  const columns = [
    ...
    {
      accessorFn: (row: any) => row.incidentType,
      id: "incidentType",
      cell: (info: any) => info.getValue(),
      header: () => <span>Incident Type</span>,
      isSortable: true,
    },
    {
      accessorFn: (row: any) => row.incidentDescription,
      id: "incidentDescription",
      cell: (info: any) => info.getValue(),
      header: () => <span>Incident Description</span>,
      isSortable: true,
    },
    {
      id: "actions",
