...
import { useYoungPersonLivingHouseholdForm } from "./useYoungPersonLivingHouseholdForm";
import { FRF1FormData } from ".";

const YoungPersonLivingHouseholdForm = ({ action, id }: any) => {
  const disabled = action === "view" ? true : false;
  const { methods, onSubmit, handleSubmit, handleBack } =
  useYoungPersonLivingHouseholdForm();
  return (
    <Card sx={{ p: 2 }}>
