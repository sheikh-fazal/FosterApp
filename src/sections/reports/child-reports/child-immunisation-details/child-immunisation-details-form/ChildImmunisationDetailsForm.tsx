...
import { useChildImmunisationDetailsForm } from "./useChildImmunisationDetailsForm";
import { FRF1FormData } from ".";

const ChildImmunisationDetailsForm = ({ action, id }: any) => {
  const disabled = action === "view" ? true : false;
  const { methods, onSubmit, handleSubmit, handleBack } =
  useChildImmunisationDetailsForm();
  return (
    <Card sx={{ p: 2 }}>
...
export default ChildImmunisationDetailsForm;
const style = {
