...
import { useCarerImmunisationDetailForm } from "./useCarerImmunisationDetailForm";
import { CarerImmunisationDetailFormValues } from ".";

const CarerImmunisationDetailForm = ({ action }: any) => {
  console.log("action" , action)
  const disabled = action === "view" ? true : false;
  const { methods } = useCarerImmunisationDetailForm();
  return (
    <Card sx={{ p: 2 }}>
...
export default CarerImmunisationDetailForm;
