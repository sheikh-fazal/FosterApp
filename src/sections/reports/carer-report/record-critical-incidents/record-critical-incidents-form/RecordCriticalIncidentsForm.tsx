...
import { useRecordCriticalIncidentsForm } from "./useRecordCriticalIncidentsForm";
import { RecordCriiticalIncidentFormValues } from ".";

const RecordCriticalIncidentsForm = ({ action }: any) => {
  console.log("action" , action)
  const disabled = action === "view" ? true : false;
  const { methods } = useRecordCriticalIncidentsForm();
  return (
    <Card sx={{ p: 2 }}>
...
export default RecordCriticalIncidentsForm;
