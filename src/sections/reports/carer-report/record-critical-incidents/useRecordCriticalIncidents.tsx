...
export const useRecordCriticalIncidents = () => {
  const path = "/reports/carer-reports/record-critical-incidents/record-critical-incidents-form";
  ...
  const columns = [
    ...
    {
      accessorFn: (row: any) => row.incidentDateForm,
      id: "incidentDateForm",
      cell: (info: any) => info.getValue(),
      header: () => <span>Incident Date From</span>,
      isSortable: true,
    },
 
    {
      accessorFn: (row: any) => row.incidentDateTo,
      id: "incidentDateTo",
      cell: (info: any) => info.getValue(),
      header: () => <span>Incident Date To</span>,
      isSortable: true,
    },
    {
