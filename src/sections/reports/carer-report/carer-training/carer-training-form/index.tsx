...
export const CarerTrainingFormDefaultValues = {
  trainingCourse: "Active Listening",
  carerStatus: "",
  trainingDateFrom: new Date(todayDate),
  trainingDateTo: new Date(todayDate),
  trainingDetails: "Nil",
  socialWorkerName: "",
  signed: "",
...
export const CarerTrainingFormValues = [
  {
    gridLength: 6,
    componentProps: {
