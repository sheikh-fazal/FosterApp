...
export const useCarerVacancy = () => {
  const path = "/reports/carer-reports/carer-vacancy/carer-vacancy-form";
  ...
  const columns = [
    ...
    {
      accessorFn: (row: any) => row.childrenPlacements,
      id: "childrenPlacements",
      cell: (info: any) => info.getValue(),
      header: () => <span>No of Children in Placements</span>,
      isSortable: true,
    },
    {
      accessorFn: (row: any) => row.totalVacancy,
      id: "totalVacancy",
      cell: (info: any) => info.getValue(),
      header: () => <span>Total Vacancy</span>,
      isSortable: true,
    },
    {
      accessorFn: (row: any) => row.availableVacancy,
      id: "availableVacancy",
      cell: (info: any) => info.getValue(),
      header: () => <span>Available Vacancy</span>,
      isSortable: true,
    },
    {
      id: "actions",
