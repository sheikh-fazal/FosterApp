...
export const childBirthMother = [
  ...
  },
  {
    componentProps: {
      name: "photoghraph",
      label: "Reason given where photoghraph is not available",
      multiline: true,
      minRows: 3,
      sx: { mb: 4 },
    },
...
export const childBirthMotherDataValues = {
  // yourrequest: "",
  // location: "",
  // briefsummary: "",
  // referrersname: "",
...
export const childBirthMotherValidationSchema = Yup.object().shape({
