...
import { useSingleChildDataExchange } from "./useSingleChildDataExchange";
import { singleChildDataExchangeFormData } from ".";

const SingleChildDataExchange = () => {
  const { router, theme, handleSubmit, onSubmit, methods, isSubmitting } = useSingleChildDataExchange()

  return (
    <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
      <Grid container spacing={3} py="30px">
        {singleChildDataExchangeFormData.map((form: any, i: any) => {
          return (
...
export default SingleChildDataExchange;
