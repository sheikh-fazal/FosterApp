...
import { useOngoingEvent } from "./useOngoingEvent";
...
const OngoingEvent = () => {
  ...
  const columns = [
    ...
    {
      accessorFn: (row: any) => <span style={{cursor:"pointer"}} onClick={()=>{console.log("calender clicked")}}><CalendarMonthIcon /></span>,
      id: "Schedule",
      cell: (info: any) => info.getValue(),
    ...
    {
      accessorFn: (row: any) => <span style={{cursor:"pointer"}} onClick={()=>{console.log("Presenter clicked")}}><MicIcon /></span>,
      id: "Presenter",
      cell: (info: any) => info.getValue(),
    ...
    {
      accessorFn: (row: any) =><span style={{cursor:"pointer"}} onClick={()=>{console.log("Attendee clicked")}}> <GroupsIcon /></span>,
      id: "Attendees",
      cell: (info: any) => info.getValue(),
