...
import { useFullCalenderView } from "./useFullCalenderView";
import { Box, Checkbox } from "@mui/material";
import TableAction from "@root/components/TableAction";
import DeleteModel from "@root/components/modal/DeleteModel";
const FullCalenderView = () => {
  const { data, openDelete, setOpenDelete } = useFullCalenderView();
...
export default FullCalenderView;
