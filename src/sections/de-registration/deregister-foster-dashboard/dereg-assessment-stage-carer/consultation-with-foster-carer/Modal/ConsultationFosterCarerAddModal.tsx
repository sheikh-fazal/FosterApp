...
import { FosterCarerAddModalMockData } from ".";
import RHFUploadFile from "@root/components/hook-form/RHFUploadFile";
import useConsultationFosterCarerAddModal from "./useConsultationFosterCarerAddModal";
        ...
        <ModalContent>
          ...
          <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
            <Grid container spacing={2}>
              {FosterCarerAddModalMockData?.map((item: any, i: number) => (
...
export default ConsultationFosterCarerAddModal;
