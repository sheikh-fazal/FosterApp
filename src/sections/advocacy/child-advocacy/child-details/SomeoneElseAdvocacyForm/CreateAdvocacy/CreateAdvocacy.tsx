    ...
    <Card sx={{ p: 2 }}>
      ...
      <Grid container>
        <Grid item xs={6} my={4}>
          ...
          <Select name='advocacyRequirement' fullWidth size='small' onChange={handleAdvocacy}>
        ...
        <Grid item xs={12} mb={2}>
          ...
          <Button
            ...
            variant="contained"
            sx={{ ml: 2 }}
            onClick={() => router.push({ pathname: '/advocacy/child-advocacy/child-details/someone-else-advocacy-form/create-advocacy/create-advocacy-form', query: advocacyRequirment })}
          >
            Next
          </Button>
        </Grid>
