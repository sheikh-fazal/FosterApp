...
const StandardForSafeguardingChildren = () => {
  const tableArray = [
    {
      title: "Standard 4.1",
      description:
    ...
    {
      title: "Standard 4.2",
      description: "Foster carers actively safeguard and promote the welfare of foster children.",
    },
    {
      title: "Standard 4.3",
      description:
    ...
    {
      title: "Standard 4.5",
      description: "The service implements a proportionate approach to any risk assessment",
    },
    {
      title: "Standard 4.6",
      description:
...
export default StandardForSafeguardingChildren;
