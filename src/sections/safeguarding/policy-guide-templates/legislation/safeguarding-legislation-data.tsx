import IndependentFostering from "./independent-fostering";
import StandardForSafeguardingChildren from "./standard-4-safeguading-children";

const IndependentFosteringDATA = [
  {
    id: "1",
    head: "Regulations 11",
...
const ARRANGEMENTPROTECTIONDATA = [
  {
    id: "1",
    head: "Regulations 12",
...
export const LEGISLATIONTABSDATA = [
  ...
  },
  {
    ...
    innerData: <StandardForSafeguardingChildren />,
  },
  {
    index: 2,
  ...
  },
  {
    ...
    innerData: (
      <IndependentFostering safeguadingList={ARRANGEMENTPROTECTIONDATA} backgroundColor="linear-gradient(106.35deg, #2CB764 0%, #33E87C 100%)" />
    ),
  },
  {
    index: 4,
    ...
    innerData: (
      <IndependentFostering safeguadingList={EXPECTEDOUTCOMEDATA} backgroundColor="linear-gradient(106.35deg, #0E918C 0%, #23E0D9 100%)" />
    ),
  },
];
