            ...
            <Grid item sm={12} sx={{ padding: "0.5em" }}>
              ...
              {havePs45 === "No" && (
                <>
                  ...
                  <Grid item sm={12} container sx={{ padding: "0.5em" }}>
                    ...
                    <Grid item sm={11}>
                      <Typography sx={{ color: "#343A40", mt: 0.5 }}>
                        A. Do not choose this statement if you’re in receipt of
                        a State, works or private pension. Choose this statement
                        if the following applies.
                      </Typography>
                      <Typography sx={{ color: "#343A40", mt: 0.5, pr: 2 }}>
                        This is my first job since 6 April and since the 6 April
                        I’ve not received payments from any of the following :
                      </Typography>
                      <Typography sx={{ color: "#343A40", mt: 0.5 }}>
                        <ul>
                  ...
                  <Grid item sm={12} container sx={{ padding: "0.5em" }}>
                    ...
                    <Grid item sm={11}>
                      <Typography sx={{ color: "#343A40", mt: 0.5 }}>
                        B. Do not choose this statement if you’re in receipt of
                        a State, works or private pension. Choose this statement
                        if the following applies.
                      </Typography>
                      <Typography sx={{ color: "#343A40", mt: 0.5, pr: 2 }}>
                  ...
                  <Grid item sm={12} container sx={{ padding: "0.5em" }}>
                    ...
                    <Grid item sm={11}>
                      <Typography sx={{ color: "#343A40", mt: 0.5 }}>
                        C. Do not choose this statement if you’re in receipt of
                        a State, works or private pension. Choose this statement
                        if the following applies.
                      </Typography>
                    </Grid>
                    ...
                    <Grid item container sx={{ pl: 2 }}>
                      <ul>
                        <li>
                          ...
                          undergraduate course (undergraduate or post graduate)
                        </li>
                        <li>
                          You lived in England or Wales and started your
                          undergraduate course (undergraduate or post graduate)
              ...
              {havePs45 === "Yes" && (
                <>
                  ...
                  <Grid item sm={12} sx={{ padding: "0.5em" }}>
                    <Typography sx={{ fontWeight: 600, color: "black" }}>
                      Are you repaying your student loan directly to the student
                      loans company by direct debit?
                    </Typography>
                    <RHFRadioGroup
                      name="repayingDirect"
                      options={["Yes", "No"]}
                  ...
                  <Grid item sm={12} sx={{ padding: "0.5em" }}>
                    ...
                    <Grid item>
                      <RHFSwitch name="plan1" label="Plan 1" />
                    </Grid>
                    <Grid item>
                      <RHFSwitch name="plan2" label="Plan 2" />
                    </Grid>
                  </Grid>
                  {/* Post Graduate Loan  */}
                  {/* Types of student loans  */}
