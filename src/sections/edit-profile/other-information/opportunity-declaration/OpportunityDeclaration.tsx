            ...
            <Grid item sm={12} container>
              <Grid item container>
                ...
                <p style={{ margin: "0.5em" }}>
                  ...
                  opportunity employer. The aim of our policy is to ensure no
                  job applicant or employee receives less favourable treatment
                  on the grounds of gender, age, disability/ handicap, marital
                  status, sexual orientation, careed, colour, race, or ethnic
                  origin, or is disadvantaged by conditions or requirements
                  which cannot be shown as justifiable.
                </p>
                <p style={{ margin: "0.5em" }}>
                ...
                <p style={{ margin: "0.5em" }}>
                  ...
                  policy fully effective. To ensure that this policy is fully
                  and fairly implemented and monitored, and for no other reason,
                  would you please the relevant options below?
                </p>
              </Grid>
            </Grid>
