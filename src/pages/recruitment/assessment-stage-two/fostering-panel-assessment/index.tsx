...
const BREADCRUMBS = [
  ...
  {
    name: "Fostering Panel Assessment",
    href: "",
  },
];

const PAGE_TITLE = "Fostering Panel Assessment";

FosteringPanelAssessmentStage.getLayout = function getLayout(page: any) {
  return (
    <Layout
...
export default function FosteringPanelAssessmentStage() {
