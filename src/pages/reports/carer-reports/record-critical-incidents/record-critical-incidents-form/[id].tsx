...
import RecordCriticalIncidentsForm from "@root/sections/reports/carer-report/record-critical-incidents/record-critical-incidents-form/RecordCriticalIncidentsForm";

const PAGE_TITLE = "View Carer Incidents Reports";
