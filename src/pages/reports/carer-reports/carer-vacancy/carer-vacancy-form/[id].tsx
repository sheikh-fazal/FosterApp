...
import CarerVacancyForm from "@root/sections/reports/carer-report/carer-vacancy/carer-vacancy-form/CarerVacancyForm";

const PAGE_TITLE = "View Carer Vacany Reports";
