...
import CarerImmunisationDetailForm from "@root/sections/reports/carer-report/carer-immunisation-detail/carer-immunisation-detail-form/CarerImmunisationDetailForm";
...
export default function CarerImmunisationDetailFormLayout() {
  ...
  return (
    <Page title={PAGE_TITLE} >
     <CarerImmunisationDetailForm action={action} id={id}/>
    </Page>
  );
}
