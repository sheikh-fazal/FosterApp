...
import CarerRegisterForm from "@root/sections/reports/carer-report/carer-register/carer-register-form/CarerRegisterForm";

const PAGE_TITLE = "View Carer Register Reports";
