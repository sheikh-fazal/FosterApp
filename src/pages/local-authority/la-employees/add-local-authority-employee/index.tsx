...
const PAGE_TILE = "Add Local Authority Employee";

const dynamicTitle = (pageTitle: any) => {
    console.log("pageTitle", pageTitle);
};

LocalAuthorityEmployee.getLayout = function getLayout(page: any) {
    return (
        <Layout
...
export default function LocalAuthorityEmployee() {
    return (
