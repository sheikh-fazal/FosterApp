...
import BackupCarerPlacementForm from "@root/sections/foster-child/other-information/placement-and-discharge-history/backup-carer-placement-discharge/BackupCarerPlacementForm";

const PAGE_TITLE = "Placement and Discharge History";

BackupCarerPlacement.getLayout = function getLayout(page: any) {
  return <Layout showTitleWithBreadcrumbs={false}>{page}</Layout>;
};

export default function BackupCarerPlacement() {
