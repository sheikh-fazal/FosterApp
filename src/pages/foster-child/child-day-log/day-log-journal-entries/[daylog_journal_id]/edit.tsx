...
// const PAGE_TITLE = "Edit Day Log Jopurnal Entries";
// // ----------------------------------------------------------------------

// EditDayLogJournalForm.getLayout = function getLayout(page: any) {
//   return (
//     <Layout
...
// export default function EditDayLogJournalForm() {
