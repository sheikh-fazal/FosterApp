...
const PolicyVerticalUploadDocument = (props: any) => {
  const { data, handleSubmit, isUploadBackBtn, addUploadDocument, onSubmitUploadDocument } = props;
  ...
  return (
    <>
      ...
      <Box>
        ...
        {isUploadBackBtn && (
          <Button sx={{ backgroundColor: "#F6830F", "&:hover": { backgroundColor: "#F6830F" } }} type="button" variant="contained">
            Back
          </Button>
        )}
      </Box>
